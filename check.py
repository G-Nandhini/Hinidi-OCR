...
test_image = cv2.imread("C:/Users/ELCOT-Lenovo/Downloads/Hindi-OCR-master/Hindi-OCR-master/tese-images/ma.png")
cv2.imshow("TestWindow",test_image)
image = cv2.resize(test_image, (32,32))
cv2.imshow("TestWindow",test_image)
cv2.waitKey(0)
cv2.destroyWindowAll()
